...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  4 23:54:00 2018
...
script_dir = os.path.dirname('test.py')
training_set_path = os.path.join(script_dir, '../Section 8 - Building a CNN/dataset/training_set')
test_set_path = os.path.join(script_dir, '../Section 8 - Building a CNN/dataset/test_set')
